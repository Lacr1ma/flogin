...
class SchedulerCest
{
    ...
    public function clear_expired_reset_password_links(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('/var/www/html/bin/typo3 scheduler:run --task=1 -f');
    ...
    public function clear_expired_magic_links(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('/var/www/html/bin/typo3 scheduler:run --task=2 -f');
    ...
    public function unlock_users(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand('/var/www/html/bin/typo3 scheduler:run --task=3 -f');
